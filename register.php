...
<body>
    ...
    <table style="border: 2px solid black; width: 40%;" align="center">
        ...
        <tr><td>ชื่อบัญชี :</td><td><input type="text" name="account name" size="60"></td></tr>
        <tr><td>รหัสผ่าน :</td><td><input type="password" name="password" size="60"></td></tr>
        <tr><td>ชื่อ-นามสกุล :</td><td><input type="text" name="name" size="60"></td></tr>
        <tr><td>เพศ :</td><td><input type="radio" name="gender" value="m">ชาย<br>
        <input type="radio" name="gender" value="f">หญิง<br>
        <input type="radio" name="gender" value="other">อื่นๆ</td></tr>

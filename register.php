                ...
                <div class="card-body">
                    <form action="register_save.php" method="post">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <div class="form-check">
                                    <input type="radio" name="gender" value="m" class="form-check-label" required>
                                    <label class="form-check-label">ชาย</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" name="gender" value="f" class="form-check-label" required>
                                    <label class="form-check-label">หญิง</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" name="gender" value="o" class="form-check-label" required>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <button class="btn btn-primary btn-sm" type="submit">สมัครสมาชิก</button>
                            </div>
                        </div>
                    </form>
                </div>
